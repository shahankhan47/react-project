...
function Menu() {
  ...
  return (
    <main className="menu">
      ...
      {numPizzas > 0 ? (
        // This is a react.Fragment to have multiple JSX elements returned from one component.
  ...
  return (
    ...
    <li className={`pizza ${pizzaObj.soldOut ? "sold-out" : ""}`}>
      ...
      <div>
        ...
        {
          // Conditional rendering: When we don't know what tag to use:
          /* {pizzaObj.soldOut ? (
            <span>SOLD OUT</span>
          ) : (
        ...
        {/* Conditional rendering: When we know what tag to use: */}
